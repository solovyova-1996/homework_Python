...
class Cell:
    ...
    def __sub__(self, other):
        difference = self.count_cell - other.count_cell
        if difference > 0:
            return Cell(difference)
        else:
            return f"Разность клеток меньше либо равна 0"
    ...
    def make_order(self, count_cell_in_row):
        a = self.count_cell // count_cell_in_row
        b = (self.count_cell - (count_cell_in_row * a)) * "*"
        return ("*" * count_cell_in_row + "\n") * a + b
